...
<TABLE width=1400 align=center cellspacing=0 cellpadding=0><TR><TD >
<SCRIPT>
...
<div class="container-fluid text-center">
  ...
  <div class="row">
    ...
    <a href="http://localhost:8084/tour-around/Pages/Guide/DistanceCalculator.jsp"><h5>DISTANCE CALCULATOR</h5></a>
    ...
    <a href="http://localhost:8084/tour-around/Pages/Guide/CurrencyConversion.jsp"><h5>CURRENCY CONVERSION</h5></a>
  ...
  <div class="row">
    <div class="col-sm-6">
     ...
     <a href="http://localhost:8084/tour-around/Pages/Insurance.jsp"><h5>INSURANCE</h5></a>
   ...
   <div class="row">
    ...
    <span class="glyphicon glyphicon-print logo-small"></span>
     ...
     <a href="http://localhost:8084/tour-around/printInvoice.jsp"><h5>PRINT INVOICE</h5></a>
