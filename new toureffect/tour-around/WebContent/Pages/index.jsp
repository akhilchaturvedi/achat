...
<div class="container-fluid text-center">
  ...
  <div class="row">
    ...
    <a href="http://localhost:8082/tour-around/Pages/Guide/DistanceCalculator.jsp"><h5>DISTANCE CALCULATOR</h5></a>
    ...
    <a href="http://localhost:8082/tour-around/Pages/Guide/CurrencyConversion.jsp"><h5>CURRENCY CONVERSION</h5></a>
  ...
  <div class="row">
    <div class="col-sm-6">
     ...
     <a href="http://localhost:8082/tour-around/Pages/Insurance.jsp"><h5>INSURANCE</h5></a>
   ...
   <div class="row">
    <div class="col-sm-6">
     ...
     <a href="http://localhost:8082/tour-around/Pages/index.jsp"><h5>TRAVELLING</h5></a>
