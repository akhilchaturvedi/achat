...
<body align="center">
<center>
<h2 style="color:Green" alignment=>From TourAndTravels.com </h2>
</center>
...
<tr bgcolor="#CCCCCC">	<td>DATE OF JOURNEY</td><td><%=rs.getString("sdd")%>/<%=rs.getString("smm")%>/<%=rs.getString("syy")%></td></tr>
...
PROOF OF PURCHASE</br>
 ...
 <b>Contact Us on- tourandtravels.com</br>
 Mail to - tourandtravelsgmail.com</b>
