 ...
 insertMenuList("Home","Travels",path+"/index.html")
 ...
 var tplayer=getRef('toplayer');
  if(!ns4) visualize("<TABLE bgcolor="+cb.tblColor+" align=center CellPadding=3 CellSpacing=1 id=tab1 OnMouseOut=highlightmenu(event,'off'); OnMouseOver=highlightmenu(event,'on'); width='1400' border=0><TR>");
 ...
 document.write("<TABLE bgcolor=#00cc66 width=180 align=left cellpadding=0 cellspacing=0><TR><TD style='padding:2px 5px 2px 5px'>");
 for(var lk in links) 
 document.write("<a class=cap href='"+navs[lk]+"'>"+cb.DPointer+"&nbsp;&nbsp;&nbsp;"+links[lk].replace("-"," ")+"</a><br>");
 document.write("</TD></TR><TR><TD><img src='"+arguments[1]+"' width=180 height=200></TD></TR><TR><TD><img src='"+arguments[2]+"' width=180 height=200></TD></TR></TABLE>");
 }
 ...
 var links=["Services","Holiday Packages","Faqs","Contact-Us","About Us","Travel-Links","Privacy Policy","Terms of Use"];
 document.write("<HR size=1 noshade width=90% align=center color=gray><TABLE width=1400  Align=center cellpadding=0 cellspacing=0><TR><TD align=center><BR>");
 var count=0;
 for(var lk in links) {
 count++;
