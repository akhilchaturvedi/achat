...
<TR><TD class=padd style='text-align:justify;color:navy;font:100 11px tahoma'><BR><B>About Us</B><BR>
The online travel industry is growing at a frenzied pace and is quickly becoming the most efficient method for travel planning. "hcutravels" is a on-line travel company offering leisure and business travellers a wide selection of low airfares, as well as deals on booking cars, hotels, railways, vacation packages, insurance and other travelling facilities. The site is created to address customer's need for an unbiased, comprehensive display of fares and rates in a single location <BR><BR>
<B>Development Team</b><br>
This site is developed by K.naveen kumar under the guidience of respected Mr.Sruzan.
<BR><BR>
<B>We Cares</B><BR>
With hcutravels, the customer relationship doesn't end when you hit the "purchase" button. With hcutravels.com you can get your deals via e-mail. hcutravels is there to make your journey as easy as possible, providing the latest information on flight delays, weather conditions, distance calculator, currency converter any other event that might impact your travel. hcutravels is there to book best hotels for you with most exotic locations at reasonable rate. 
.<BR><BR>
