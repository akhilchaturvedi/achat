 ...
 insertMenuList("Home","Travels",path+"/index.jsp")
 ...
 var tplayer=getRef('toplayer');
  if(!ns4) visualize("<TABLE bgcolor="+cb.tblColor+" align=center CellPadding=3 CellSpacing=1 id=tab1 OnMouseOut=highlightmenu(event,'off'); OnMouseOver=highlightmenu(event,'on'); width='900' border=0><TR>");
 ...
 document.write("<HR size=1 noshade width=90% align=center color=gray><TABLE width=900  Align=center cellpadding=0 cellspacing=0><TR><TD align=center><BR>");
 var count=0;
 for(var lk in links) {
 count++;
